		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Request View",
									"targetURL": "#requestviewui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"requestviewui5-display": {
								"semanticObject": "requestviewui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=requestviewui5",
									"url": sap.ui.require.toUrl("requestviewui5")
								}
							}
						}
					}
